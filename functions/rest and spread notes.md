...
- when this operator is used for a function like we did before then this is will be called as rest parameters.

# Spread : 
- When this operator is used inside arry/objects then this is known as spread parameters.
